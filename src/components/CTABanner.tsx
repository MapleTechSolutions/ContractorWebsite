    ...
    <section className="py-20 bg-[#0f1f2d] relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[clamp(1.75rem,5vw,3.5rem)] font-black text-white mb-6 tracking-tight">
            Ready to Book Your
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/contact" className="btn-primary text-base md:text-lg touch-manipulation">
              Get a Quote
            ...
            <a
              ...
              className="btn-outline-white text-base md:text-lg touch-manipulation"
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
            ...
            <div className="flex items-center gap-2 text-white/70">
              ...
              <span className="font-semibold text-sm md:text-base">WCB Saskatchewan Compliant</span>
            </div>
            <div className="flex items-center gap-2 text-white/70">
